...
namespace GUI
{
    public partial class fEditPhieuMuon : Form
    {
        ...
        private void siticoneSeparator4_Click(object sender, EventArgs e)
        {
        ...
        private void siticoneSeparator5_Click(object sender, EventArgs e)
        {

        }

        private void labelNgayMuon_Click(object sender, EventArgs e)
        {
