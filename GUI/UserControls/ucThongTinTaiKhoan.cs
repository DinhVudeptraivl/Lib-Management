...
namespace GUI.UserControls
{
    public partial class ucThongTinTaiKhoan : UserControl
    {
        ...
        private void featPanel_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void labelChucVu_Click(object sender, EventArgs e)
        {

        }

        private void botTableLayout_Paint(object sender, PaintEventArgs e)
        {
