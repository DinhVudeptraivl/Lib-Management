...
namespace GUI.UserControls
{
    public partial class ucThayDoiQuiDinh : UserControl
    {
        ...
        private void numTuoiMin_ValueChanged(object sender, EventArgs e)
        {

        }

        private void numNgayMuon_ValueChanged(object sender, EventArgs e)
        {

        }

        private void numSoSach_ValueChanged(object sender, EventArgs e)
        {
