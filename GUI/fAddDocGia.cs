...
namespace GUI
{
    public partial class fAddDocGia : Form
    {
        ...
        private void nHOMNGUOIDUNGBindingSource_CurrentChanged(object sender, EventArgs e)
        {
        ...
        private void dateNgayHetHan_Click(object sender, EventArgs e)
        {

        }

        private void comboLoaiDG_SelectedIndexChanged(object sender, EventArgs e)
        {
